...
public interface IHCAnalysisMapper {
    @Insert("INSERT INTO ihc_analysis_result(image_name, positive_area, total_area, analysis_date, foldername) " +
            "VALUES(#{imageName}, #{positiveArea}, #{totalArea}, #{analysisDate}, #{folderName})")
